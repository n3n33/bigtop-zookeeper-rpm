...
for module in zookeeper-contrib-rest; do
    cp -r ${BUILD_DIR}/zookeeper-contrib/${module} ${PREFIX}/${LIB_DIR}/contrib/
done
...
for module in zookeeper-contrib-rest; do
    cp -r ${BUILD_DIR}/zookeeper-contrib/${module} ${PREFIX}/${LIB_DIR}/contrib/
    mv ${PREFIX}/${LIB_DIR}/contrib/zookeeper-contrib-rest/conf ${PREFIX}/${CONF_DIST_DIR}/${module}
done
...
cp -R build/include/* ${PREFIX}/${SYSTEM_INCLUDE_DIR}/
cp -R build/lib*/* ${PREFIX}/${SYSTEM_LIB_DIR}/
cp -R build/bin/* ${PREFIX}/${LIB_DIR}-native/
